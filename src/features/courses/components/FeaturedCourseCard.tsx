...
// Category badge color mapping for visual variety
  ...
  return (
    ...
    >
      ...
      <View style={styles.content}>
        ...
        {/* CTA Button (if not enrolled) */}
        {!course.isEnrolled && course.ctaText && (
          <Pressable
            style={({ pressed }) => [
              styles.ctaButton,
            ...
            onPress={onPress}
          >
            <Text style={styles.ctaText}>{course.ctaText}</Text>
